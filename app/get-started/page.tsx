          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <button className="bg-brand-DEFAULT hover:bg-brand-dark text-white font-bold py-2 px-6 rounded transition duration-300">
                  Start Creating
                </button>
              </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg border border-gray-200 dark:border-gray-700">
                ...
                <button className="bg-gray-600 hover:bg-gray-500 text-white font-bold py-2 px-6 rounded transition duration-300">
                  View Documentation
                </button>
              </div>
            </div>
